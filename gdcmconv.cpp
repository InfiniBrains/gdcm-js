...
int main (int argc, char *argv[])
{
    ...
    std::cout << "assuming input as input.dcm and output as output.dcm"<<std::endl;
        // gdcmconv -w -i input.dcm -o output.dcm
    argc = 6;
    argv = (char**)malloc(6*sizeof(char*));

    argv[0] = (char*)malloc(9*sizeof(char));
    strncpy(argv[0], "gdcmconv\0",9);

    argv[1] = (char*)malloc(3*sizeof(char));
    strncpy(argv[1], "-w\0",3);

    argv[2] = (char*)malloc(3*sizeof(char));
    strncpy(argv[2], "-i\0",3);

    argv[3] = (char*)malloc(10*sizeof(char));
    strncpy(argv[3], "input.dcm\0",10);

    argv[4] = (char*)malloc(3*sizeof(char));
    strncpy(argv[4], "-o\0",3);

    argv[5] = (char*)malloc(11*sizeof(char));
    strncpy(argv[5], "output.dcm\0",11);
